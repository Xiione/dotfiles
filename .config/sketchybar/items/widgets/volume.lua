...
local function setup_device_hover(item)
        ...
        sbar.exec("SwitchAudioSource -t output -c", function(result)
            ...
            sbar.exec("SwitchAudioSource -a -t output", function(available)
                ...
                for device in string.gmatch(available, '[^\r\n]+') do
                    local color = colors.lightest_grey
                    ...
                    local device_item = sbar.add("item", "volume.device." .. counter, {
                        ...
                        colors.grey ..
                        ' --set $NAME label.color=' .. colors.white .. ' && current_audio_device="' .. device .. '"'
                    })
                    setup_device_hover(device_item)
                    counter = counter + 1
                end
            end)
        end)
