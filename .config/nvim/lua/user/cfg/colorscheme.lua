...
local function set_nord_highlights(highlights)
	...
	define("QuickFixLineNr", { fg = colors.nord10 })
	...
	define("WinBar", { fg = colors.nord3L, bg = colors.nord16 })
	define("WinBarNC", { fg = colors.nord3L, bg = colors.nord16 })
	define("DropBarKindFile", { fg = colors.nord4, bg = colors.nord16 })
	define("DropBarKindFileNC", { link = "DropBarKindFile" })
	define("DropBarIconUISeparator", { fg = colors.nord3, bg = colors.nord16 })
