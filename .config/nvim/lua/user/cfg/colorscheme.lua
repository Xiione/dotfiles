...
local function set_nord_highlights(highlights)
	...
	define("SnacksGhGreen", { link = "diffAdded" })
	define("SnacksGhRed", { link = "diffRemoved" })
	define("SnacksGhPurple", { link = "Number" })
	define("SnacksGhGray", { link = "Comment" })
	...
	define("lualine_transparent", { link = "lualine_c_normal" })
	...
	define("DropBarIconUIPickPivot", { fg = colors.nord9 })
